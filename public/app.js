...
function collectAnswers() {
  ...
  return {
    ...
    has_vision_loss:                fd.get('vision_loss') === 'on',
    has_cancer:                     fd.get('cancer') === 'on',
    has_blood_cancer:               fd.get('blood_cancer') === 'on',
    has_autism:                     fd.get('autism') === 'on',
    has_parkinsons:                 fd.get('parkinsons') === 'on',
